...
public class GliderTask extends BukkitRunnable {
    ...
    public void run() {
        ...
        Block relativeBlock =  gliderFeetLoc.getBlock().getRelative(BlockFace.DOWN);
        if (( relativeBlock.getType().equals(Material.AIR)) || relativeBlock.getType().equals(Material.RAILS) || relativeBlock.getType().equals(Material.ACTIVATOR_RAIL) || relativeBlock.getType().equals(Material.FIRE)) {
